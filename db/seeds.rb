...
u5 = User.create( nickname: 'Blockedguy', email: 'blockedguy@gmail.com', password: 'block123', role: 'user', name: 'Elmo', last_name: 'Guy', bio: 'making everyone hate me', location: 'Circle 9, Hell', geofence: '', profession: 'Devil')
